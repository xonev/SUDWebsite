<?php
/**
 * @version		$Id: toolbar.directory_categories.html.php 10465 2008-06-28 13:20:22Z willebil $
 * @package		Joomla
...
* @subpackage	DirectoryCategories
*/
class TOOLBAR_directory_categories {
	/**
	...
	*/
	function _EDIT($edit)
	{
		...
		JToolBarHelper::help( 'screen.' . substr( $section, 4 ) . '.directory_categories.edit' );
	}
	...
	*/
	function _DEFAULT()
	{
		...
		JToolBarHelper::help( 'screen.' . substr( $section, 4 ) . '.directory_categories' );
	}
}
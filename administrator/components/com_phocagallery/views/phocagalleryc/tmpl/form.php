			...
			<fieldset class="adminform">
				<legend><?php echo JText::_( 'Details' ); ?></legend>
					...
					<tr>
						...
						<td valign="middle">
							<input class="text_area" type="text" name="longitude" id="longitude" value="<?php echo $this->longitude; ?>" size="32" maxlength="250" />
						</td>
						<td align="left" valign="middle">
							<div class="button2-left" style="display:inline">
					...
					<tr>
						...
						<td valign="middle">
							<input class="text_area" type="text" name="latitude" id="latitude" value="<?php echo $this->latitude; ?>" size="32" maxlength="250" />
						</td>
					</tr>
					...
					<tr>
						...
						<td valign="middle">
							<input class="text_area" type="text" name="zoom" id="zoom" value="<?php echo $this->zoom; ?>" size="32" maxlength="250" />
						</td>
					</tr>
					...
					<tr>
						...
						<td valign="middle">
							<input class="text_area" type="text" name="geotitle" id="geotitle" value="<?php echo $this->geotitle; ?>" size="32" maxlength="250" />
						</td>
					</tr>
